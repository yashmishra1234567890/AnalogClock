...
def update_clock():
    ...
    canvas.create_oval(2,2,WIDTH,HEIGHT,outline="grey",width=2)
    ...
    for i in range(12):
        ...
        if i ==0:
            canvas.create_text(x,y-10,text=str(i+12),font=("Helvectica",12))
        else:
            canvas.create_text(x,y,text=str(i),font=("Helvectica",12))
